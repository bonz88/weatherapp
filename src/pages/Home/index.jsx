...
const Home = ({handleCurrentLocation}) => {
  ...
  const defaultImg = "https://images.unsplash.com/photo-1499346030926-9a72daac6c63?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=3270&q=80";
  ...
  const sendLocation = async (pos) => {
    try {
      setIsLoading(true);
      const position = await axios(`https://api.openweathermap.org/data/2.5/weather?lat=${pos.coords.latitude}&lon=${pos.coords.longitude}&appid=1fb24a4d9df7fe564611dea433db08b0`);
      setIsLoading(false);
